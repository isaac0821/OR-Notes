...
\usepackage{tikz}
	...
	\tikzstyle{link} = [thick, -]
	\tikzstyle{circleNode} = [circle, minimum size = 0.7cm, text centered, draw=black, inner sep=0.1cm]
...
\begin{document}
	...
	% \include{05-Algorithms_and_Computational_Complexity}
	% \include{06-Heuristics_and_Meta-heuristics}

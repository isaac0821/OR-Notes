	...
	\chapter{Paths, Trees, and Cycles}
		\section{Walk}
	 	...
	 	\section{Tree and forest}
	 		...
	 		\begin{definition}[forest, tree, spanning tree]
			...
			Every connected graph has a spanning tree. We are going to use the following algorithm as proof.
			...
			\notice{This algorithm can be optimized, one idea is to make summation of edges in spanning subgraph less or equation to $|V| - 1$}
		...
		\section{Complexity}
			\fixme{This part is going to be moved to Algorithm notes, (or I will just delete this part because of duplication)}

			...
			\subsection{Example for cycling}
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\draw [arrow] (1) to [out = 230, in = 70] node [right] {1, a} (2);
						\draw [arrow] (3) to [out = -165, in = -15] node [below] {3, i (out)} (2);
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\node (2) [circleNode, below of = 1, xshift=-1.5cm] {2};
						\node (3) [circleNode, below of = 1, xshift=1.5cm] {3};
						\draw [arrow] (1) to [out = 230, in = 70] node [right] {1, a (out)} (2);
						\draw [arrow] (3) to [out = -135, in = -45] node [below] {-3, j} (2);
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\draw [arrow, dashed] (2) to [out = 15, in = 165] node [above] {3, d (in)} (3);
					\end{tikzpicture}
				\end{figure}\\
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\node (3) [circleNode, below of = 1, xshift=1.5cm] {3};
						\draw [arrow] (1) to [out = -50, in = 110] node [left] {1, f} (3);
						\draw [arrow] (2) to [out = 15, in = 165] node [above] {3, d (out)} (3);
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\node (2) [circleNode, below of = 1, xshift=-1.5cm] {2};
						\node (3) [circleNode, below of = 1, xshift=1.5cm] {3};
						\draw [arrow, dashed] (1) to [out = -25, in = 90] node [above] {-1, g (in)} (3);
						\draw [arrow] (1) to [out = 180, in = 110] node [left] {3, c} (2);
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\draw [arrow, dashed] (3) to [out = -165, in = -15] node [below] {3, i (in)} (2);
					\end{tikzpicture}
				\end{figure}\\
				...
				\begin{figure}[!ht]
					...
					\begin{tikzpicture}[node distance=2.5cm]
						...
						\node (2) [circleNode, below of = 1, xshift=-1.5cm] {2};
						\node (3) [circleNode, below of = 1, xshift=1.5cm] {3};
						\draw [arrow, dashed] (1) to [out = 230, in = 70] node [right] {1, a (in)} (2);
						\draw [arrow] (1) to [out = -25, in = 90] node [above] {-1, g (out)} (3);
						\draw [arrow] (3) to [out = -165, in = -15] node [below] {3, i} (2);
					\end{tikzpicture}
				\end{figure}\\
		...
		\section{Out-of-Kilter algorithm}
			...
			\begin{figure}[!ht]
				...
				\begin{tikzpicture}[node distance = 1.6cm]
					\node (1) [solidNode, label=below:{$v_1$}] {};
					\node (2) [solidNode, below of = 1, label=below:{$v_2$}] {};
					\node (3) [solidNode, below of = 2, label=below:{$v_3$}] {};
					\node (4) [solidNode, right of = 1, xshift=1.8cm, label=below:{$v_4$}] {};
					\node (5) [solidNode, right of = 2, xshift=1.8cm, label=below:{$v_5$}] {};
					\node (6) [solidNode, right of = 3, xshift=1.8cm, label=below:{$v_6$}] {};
					\node (s) [solidNode, below of=3, label=below:{s}] {};
					\node (t) [solidNode, below of=6, label=below:{t}] {};
					...
					\draw [arrow] (3) -- node [below, xshift=1.2cm, yshift=0.4cm] {$e_{10}: (0, 8, 3)$} (5);
					\draw (s) [arrow] to [out = 180, in = 180] node [left, xshift=1cm, yshift=-0.7cm] {$e_1: (0, 1, 0)$} (1);
					\draw (s) [arrow] to [out = 180, in = 180] node [left, xshift=1cm, yshift=-0.7cm] {$e_2: (0, 3, 0)$} (2);
					\draw (s) [arrow] to [out = 180, in = 180] node [right] {$e_3: (0, 4, 0)$} (3);
					\draw (4) [arrow] to [out = 0, in = 0] node [right, xshift=-1cm, yshift=-0.7cm] {$e_{11}: (0, 2, 0)$} (t);
					\draw (5) [arrow] to [out = 0, in = 0] node [right, xshift=-1cm, yshift=-0.7cm] {$e_{12}: (0, 2, 0)$} (t);
			...
			\begin{figure}[!ht]
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						\draw [arrow] (0, 0) -- (0, 4);
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (8, -7) -- (8, 4);
						\draw node at (0, 4) [above] {$y_t - y_s$};
						\draw node at (10, 0) [above] {$x_0$};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_s - y_1$};
						\draw node at (10, 0) [above] {$x_1$};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_s - y_2$};
						\draw node at (10, 0) [above] {$x_2$};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_s - y_3$};
						\draw node at (10, 0) [above] {$x_3$};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_1 - y_4$};
						\draw node at (10, 0) [above] {$x_4$};
						\draw node at (8, -0.5) [right] {8};
						\draw node at (0, 0) [left] {0};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_1 - y_5$};
						\draw node at (10, 0) [above] {$x_5$};
						\draw node at (8, -0.5) [right] {8};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_1 - y_6$};
						\draw node at (10, 0) [above] {$x_6$};
						\draw node at (8, -0.5) [right] {8};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 1) -- (8, 1) -- (8, 4);
						\draw node at (0, 4) [above] {$y_2 - y_4$};
						\draw node at (10, 0) [above] {$x_7$};
						\draw node at (8, -0.5) [right] {8};
						\draw node at (0, 1) [left] {1};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 3) -- (8, 3) -- (8, 4);
						\draw node at (0, 4) [above] {$y_2 - y_6$};
						\draw node at (10, 0) [above] {$x_8$};
						\draw node at (8, -0.5) [right] {8};
						\draw node at (0, 3) [left] {3};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 3) -- (8, 3) -- (8, 4);
						\draw node at (0, 4) [above] {$y_3 - y_4$};
						\draw node at (10, 0) [above] {$x_9$};
						\draw node at (8, -0.5) [right] {8};
						\draw node at (0, 3) [left] {3};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 3) -- (8, 3) -- (8, 4);
						\draw node at (0, 4) [above] {$y_3 - y_5$};
						\draw node at (10, 0) [above] {$x_{10}$};
						\draw node at (8, -0.5) [right] {8};
						\draw node at (0, 3) [left] {3};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw node at (0, 4) [above] {$y_4 - y_t$};
						\draw node at (10, 0) [above] {$x_{11}$};
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 0) -- (2, 0) -- (2, 4);
						\draw node at (0, 4) [above] {$y_5 - y_t$};
						\draw node at (10, 0) [above] {$x_{12}$};
						\draw node at (2, -0.5) [right] {2};
						\draw node at (0, 0) [left] {0};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
				...
				\begin{subfigure}[c]{0.15\textwidth}
					...
					\begin{tikzpicture}[scale = 0.21]
						...
						\draw [arrow] (0, 0) -- (10, 0);
						\draw [link, line width=0.6mm] (0, -1) -- (0, 0) -- (4, 0) -- (4, 4);
						\draw node at (0, 4) [above] {$y_6 - y_t$};
						\draw node at (10, 0) [above] {$x_{13}$};
						\draw node at (4, -0.5) [right] {4};
						\draw node at (0, 0) [left] {0};
						\fill (0, 0) circle [radius=10pt];
					\end{tikzpicture}
			...
			\end{figure}\\
			\newpage
			Iteration 1: (Flow-change) Augmenting cycle $\{s v_1 v_4 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\begin{figure}[!ht]
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 3: (Flow-change) Augmenting cycle $\{s v_2 v_4 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\begin{figure}[!ht]
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 5: (Flow-change) Augmenting cycle $\{s v_2 v_4 v_1 v_5 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 6: (Number-change) $X = \{s v_2 v_3 v_4\}$, $t \notin X$, vertex number change by $\epsilon = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\end{figure}\\
			\newpage
			Iteration 7: (Flow-change) Augmenting cycle $\{s v_2 v_6 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 8: (Flow-change) Augmenting cycle $\{s v_3 v_5 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 9: (Number-change) $X=\{s v_1 v_3 v_5\}$, $t \notin X$, vertex number change by $\epsilon = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\end{figure}\\
			\newpage
			Iteration 10: (Flow-change) Augmenting cycle $\{s v_3 v_5 v_1 v_4 v_2 v_6 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 11: (Number-change) $X = \{s v_3 v_5\}$, $t \notin X$, vertex number change by $\epsilon = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 12: (Flow-change) Augmenting cycle $\{s v_3 v_4 v_2 v_6 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\end{figure}\\
			\newpage
			Iteration 13: (Number-change) $X = \{s v_1 v_3 v_4 v_5\}$, $t \notin X$, vertex number change by $\epsilon = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
				...
				\end{subfigure}
			\end{figure}\\
			Iteration 14: (Flow-change) Augmenting cycle $\{s v_3 v_4 v_1 v_6 t s\}$ detected, augment by $\Delta = 1$\\
			\begin{figure}[!ht]
				\centering
				\begin{subfigure}[c]{0.15\textwidth}
					\centering
			...
			\begin{figure}[!ht]
				...
				\begin{tikzpicture}[node distance = 2cm]
					...
					\node (s) [solidNode, below of=3, label=below:{s}] {};
					\node (t) [solidNode, below of=6, label=below:{t}] {};
					\draw [arrow] (1) -- node [above] {$f_4 = 0$} (4);
					\draw [arrow] (1) -- node [right, xshift=0.7cm, yshift=-0.3cm] {$f_5 = 0$} (5);
					\draw [arrow] (1) -- node [right, xshift=-0.1cm, yshift=-0.1cm] {$f_6 = 1$} (6);
					\draw [arrow] (2) -- node [left, xshift=-0.5cm, yshift=-0.3cm] {$f_7 = 0$} (4);
					\draw [arrow] (2) -- node [below, xshift=0.3cm, yshift=-0.3cm] {$f_8 = 3$} (6);
					\draw [arrow] (3) -- node [left, xshift=-0.6cm, yshift=-1cm] {$f_9 = 2$} (4);
					\draw [arrow] (3) -- node [below, xshift=1.2cm, yshift=0.4cm] {$f_{10} = 2$} (5);
					\draw (s) [arrow] to [out = 180, in = 180] node [left, xshift=1cm, yshift=-0.7cm] {$f_1 = 1$} (1);
					\draw (s) [arrow] to [out = 180, in = 180] node [left, xshift=1cm, yshift=-0.7cm] {$f_2 = 3$} (2);
					\draw (s) [arrow] to [out = 180, in = 180] node [right] {$f_3 = 4$} (3);
					\draw (4) [arrow] to [out = 0, in = 0] node [right, xshift=-1cm, yshift=-0.7cm] {$f_{11} = 2$} (t);
					\draw (5) [arrow] to [out = 0, in = 0] node [right, xshift=-1cm, yshift=-0.7cm] {$f_{12} = 2$} (t);
					\draw (6) [arrow] to [out = 0, in = 0] node [left] {$f_{13} = 4$} (t);
					\draw [arrow] (t) -- node [below] {$f_0 = 8$} (s);
				\end{tikzpicture} 
			\end{figure}\\

			And the total weight is 
			\begin{equation}
				w = \sum_{e} f_e w_e = f_6w_6 + f_8w_8 + f_9w_9 + f_{10}w_{10} = 3 + 9 + 6 + 6 = 24
			\end{equation}
			\twocolumn

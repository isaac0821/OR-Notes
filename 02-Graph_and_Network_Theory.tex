		...
		\section{All pairs shortest path problem}
			...
			\begin{figure}
				...
				\begin{tikzpicture}[node distance = 2cm]
					...
					\node (4) [circleNode, below of=2, xshift = 1cm] {1};
		...
		\section{Floyd-Warshall Algorithm}
			...
			\begin{figure}
				...
				\begin{tikzpicture}[node distance = 2cm]
					\node (2) [circleNode] {2};
					\node (1) [circleNode, below of=2, xshift = -1cm] {1};
					\node (3) [circleNode, below of=2, xshift = 1cm] {3};
					\node (4) [circleNode, below of=3, xshift = -0.3cm] {1};
					\node (5) [circleNode, below of=1, xshift = 0.3cm] {5};
